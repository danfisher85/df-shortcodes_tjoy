...
$zilla_shortcodes['animate'] = array(
	'no_preview' => true,
	'params' => array(
		'animation' => array(
			'type' => 'select',
			'label' => __('Animation', 'tjoy'),
			'desc' => __('Select animation type', 'tjoy'),
			'options' => array(
				'bounce' => 'bounce',
				'flash' => 'flash',
				'pulse' => 'pulse',
		...
		'delay' => array(
			'type' => 'text',
			'std' => '200',
			'label' => __('Animation Delay', 'tjoy'),
			'desc' => __('Set animation delay in ms', 'tjoy')
		),
		'content' => array(
			'std' => '',
			'type' => 'textarea',
			'label' => __('Content', 'tjoy'),
			'desc' => __('Add you content here', 'tjoy')
		)
	),
	'shortcode' => '[animate animation="{{animation}}" delay="{{delay}}"] {{content}} [/animate]',
	'popup_title' => __('Insert Animation Shortcode', 'tjoy')
);
...
$zilla_shortcodes['button'] = array(
	...
	'params' => array(
		'link' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Button URL', 'tjoy'),
			'desc' => __('Add the button\'s url eg http://example.com', 'tjoy')
		),
		'color' => array(
			'type' => 'select',
			'label' => __('Button Style', 'tjoy'),
			'desc' => __('Select the button\'s style, ie the button\'s colour', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'primary' => 'Primary',
				'warning' => 'Warning',
		...
		'text' => array(
			'std' => 'Button Text',
			'type' => 'text',
			'label' => __('Button\'s Text', 'tjoy'),
			'desc' => __('Add the button\'s text', 'tjoy'),
		),
		'size' => array(
			'type' => 'select',
			'label' => __('Button Size', 'tjoy'),
			'desc' => __('Select the button\'s size', 'tjoy'),
			'options' => array(
				'normal' => 'Normal',
				'sm' => 'Small',
				'xs' => 'Extra Small',
		...
		'target' => array(
			'type' => 'select',
			'label' => __('Button Target', 'tjoy'),
			'desc' => __('_self = open in same window. _blank = open in new window', 'tjoy'),
			'options' => array(
				'_self' => '_self',
				'_blank' => '_blank'
			)
		...
		'icon' => array(
			'type' => 'select',
			'label' => __('Icon', 'tjoy'),
			'desc' => __('Select the button\'s icon', 'tjoy'),
			'options' => $fontawesome_icons
		)
		
	),
	'shortcode' => '[button text="{{text}}" link="{{link}}" color="{{color}}" size="{{size}}" target="{{target}}" icon="{{icon}}"]',
	'popup_title' => __('Insert Button Shortcode', 'tjoy')
);
...
$zilla_shortcodes['alert'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Alert Style', 'tjoy'),
			'desc' => __('Select the alert\'s style, ie the alert colour', 'tjoy'),
			'options' => array(
				'danger' => 'Danger',
				'warning' => 'Warning',
				'info' => 'Info',
		...
		'content' => array(
			'std' => 'Your Alert!',
			'type' => 'textarea',
			'label' => __('Alert Text', 'tjoy'),
			'desc' => __('Add the alert\'s text', 'tjoy'),
		)
		
	),
	'shortcode' => '[alert type="{{type}}"] {{content}} [/alert]',
	'popup_title' => __('Insert Alert Shortcode', 'tjoy')
);
...
$zilla_shortcodes['columns'] = array(
	...
	'popup_title' => __('Insert Column Shortcode', 'tjoy'),
	'no_preview' => true,
	...
	'child_shortcode' => array(
		'params' => array(
			'grid' => array(
				'type' => 'select',
				'label' => __('Column Width', 'tjoy'),
				'desc' => __('Choose width of the column.', 'tjoy'),
				'options' => array(
					'col-md-1' => 'Column 1',
					'col-md-2' => 'Column 2',
					'col-md-3' => 'Column 3',
			...
			'custom_class' => array(
				'type' => 'text',
				'label' => __('Custom Class', 'tjoy'),
				'desc' => __('Column custom class.', 'tjoy'),
				'std'  => ''
			),
			'content' => array(
				'std' => '',
				'type' => 'textarea',
				'label' => __('Column Content', 'tjoy'),
				'desc' => __('Add the column\'s content.', 'tjoy'),
			)
		),
		'shortcode' => '[{{grid}} class="{{custom_class}}"] {{content}} [/{{grid}}] ',
		'clone_button' => __('Add Column', 'tjoy')
	)
);


/*-----------------------------------------------------------------------------------*/
/*	Columns Inner Config
/*-----------------------------------------------------------------------------------*/

$zilla_shortcodes['columns_inner'] = array(
	'params' => array(),
	'shortcode' => '[row_inner] {{child_shortcode}} [/row_inner]', // as there is no wrapper shortcode
	'popup_title' => __('Insert Column Shortcode', 'tjoy'),
	'no_preview' => true,
...
$zilla_shortcodes['hr'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Size', 'tjoy'),
			'desc' => __('Choose the rule\'s size', 'tjoy'),
			'options' => array(
				'solid' => 'Solid',
				'double' => 'Double',
				'alt' => 'Solid Alternative'
			)
		)
	),
	'shortcode' => '[hr type="{{type}}"]',
	'popup_title' => __('Insert Rule Shortcode', 'tjoy')
);
...
$zilla_shortcodes['spacer'] = array(
	...
	'params' => array(
		'size' => array(
			'type' => 'select',
			'label' => __('Spacer Size', 'tjoy'),
			'desc' => __('Select the spacer\'s style', 'tjoy'),
			'options' => array(
				'normal' => 'Normal',
				'sm' => 'Small',
				'xs' => 'Extra Small',
		...
		'class' => array(
			'type' => 'text',
			'label' => __('Custom Class', 'tjoy'),
			'desc' => __('Add custom class here.', 'tjoy'),
			'std' => ''
		)
		
	),
	'shortcode' => '[spacer size="{{size}}" class="{{class}}"]',
	'popup_title' => __('Insert Spacer Shortcode', 'tjoy')
);
...
$zilla_shortcodes['icobox'] = array(
	...
	'params' => array(
		'color' => array(
			'type' => 'select',
			'label' => __('Color', 'tjoy'),
			'desc' => __('Select the icobox\'s color', 'tjoy'),
			'options' => array(
				'primary' => 'Primary',
				'secondary' => 'Secondary',
				'tertiary' => 'Tertiary'
		...
		'title' => array(
			...
			'type' => 'text',
			'label' => __('Title', 'tjoy'),
			'desc' => __('Add the icoboxe\'s text', 'tjoy'),
		),
		'url' => array(
			'std' => '#',
			'type' => 'text',
			'label' => __('URL', 'tjoy'),
			'desc' => __('Add the icoboxe\'s url', 'tjoy'),
		),
		'desc' => array(
			'std' => 'Some short text goes here',
			'type' => 'textarea',
			'label' => __('Description', 'tjoy'),
			'desc' => __('Add some text to describe this service/feature', 'tjoy'),
		),
		'btn_txt' => array(
			'std' => 'Read More',
			'type' => 'text',
			'label' => __('Button Text', 'tjoy'),
			'desc' => __('Add the icoboxe\'s button text or leave it empty if you don\'t want to show button. ', 'tjoy'),
		),
	),
	'shortcode' => '[icobox color="{{color}}" icon="{{icon}}" title="{{title}}" url="{{url}}" desc="{{desc}}" btn_txt="{{btn_txt}}"]',
	'popup_title' => __('Insert Icobox Shortcode', 'tjoy')
);
...
$zilla_shortcodes['cta'] = array(
	...
	'params' => array(
		...
		'fullwidth' => array(
			'type' => 'select',
			'label' => __('Full width', 'tjoy'),
			'desc' => __('Box layout', 'tjoy'),
			'options' => array(
				'no' => 'No',
				'yes' => 'Yes'
			)
		...
		'title' => array(
			...
			'type' => 'text',
			'label' => __('Title', 'tjoy'),
			'desc' => __('Add the title of this box', 'tjoy'),
		),
		'subtitle' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Subtitle', 'tjoy'),
			'desc' => __('Add the subtitle of this box', 'tjoy'),
		),
		'btn_url' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Button\'s URL', 'tjoy'),
			'desc' => __('Add the button\'s url eg http://example.com', 'tjoy')
		),
		'btn_txt' => array(
			'std' => 'Button Text',
		...
		'btn_class' => array(
			'type' => 'select',
			'label' => __('Button\'s Class', 'tjoy'),
			'desc' => __('Select the button\'s class', 'tjoy'),
			'options' => array(
				'primary' => 'Primary',
				'default' => 'Default',
				'danger' => 'Danger',
		...
		'custom_bg_url' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Custom Background URL', 'tjoy'),
			'desc' => __('Add url to you custom background image', 'tjoy'),
		)
	),
	'shortcode' => '[cta color="{{color}}" orient="{{orient}}" fullwidth="{{fullwidth}}" title="{{title}}" subtitle="{{subtitle}}" btn_txt="{{btn_txt}}" btn_url="{{btn_url}}" btn_class="{{btn_class}}" custom_bg_url="{{custom_bg_url}}"]',
	'popup_title' => __('Insert Call to Action Shortcode', 'tjoy')
);
...
$zilla_shortcodes['counter'] = array(
	'no_preview' => true,
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Style', 'tjoy'),
			'desc' => __('Select the post\'s style', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'boxed' => 'Boxed'
			)
		...
		'num' => array(
			...
			'type' => 'text',
			'label' => __('Value', 'tjoy'),
			'desc' => __('Put your value here.', 'tjoy'),
		),
		'content' => array(
			'std' => '',
			'type' => 'textarea',
			'label' => __('Counter Title', 'tjoy'),
			'desc' => __('Add short info about this number.', 'tjoy')
		)
	),
...
$zilla_shortcodes['table'] = array(
	...
	'params' => array(
		'class' => array(
			'type' => 'text',
			'label' => __('Custom Class', 'tjoy'),
			'desc' => __('Add you own class or next one: table-striped, table-bordered, table-hover, table-condensed', 'tjoy'),
			'std' => 'table-striped-vertical'
		),
		'cols' => array(
			'std' => 'names,values',
			'type' => 'text',
			'label' => __('Header cells', 'tjoy'),
			'desc' => __('Contains header information. Separate values with commas.', 'tjoy'),
		),
		'data' => array(
			'std' => 'name1,25,name2,409',
			'type' => 'text',
			'label' => __('Standard cells', 'tjoy'),
			'desc' => __('Contains table data. Separate values with commas.', 'tjoy'),
		)
	),
	'shortcode' => '[table class="{{class}}" cols="{{cols}}" data="{{data}}"]',
	'popup_title' => __('Insert Table Shortcode', 'tjoy')
);
...
$zilla_shortcodes['recent_posts'] = array(
	...
	'params' => array(
		'num' => array(
			'std' => '4',
			'type' => 'text',
			'label' => __('Number of Posts', 'tjoy'),
			'desc' => __('Change the number of displayed posts', 'tjoy'),
		),
		'words_num' => array(
			'std' => '15',
			'type' => 'text',
			'label' => __('Number of Words (excerpt)', 'tjoy'),
			'desc' => __('Change the number of displayed words', 'tjoy'),
		),
		'img_size' => array(
			'type' => 'select',
			'label' => __('Image Size', 'tjoy'),
			'desc' => __('Select the post\'s image size', 'tjoy'),
			'options' => array(
				'small' => 'Small',
				'portfolio-n' => 'Normal',
				'portfolio-lg' => 'Large'
...
$zilla_shortcodes['posts'] = array(
	...
	'params' => array(
		...
		'order' => array(
			'type' => 'select',
			'label' => __('Order', 'tjoy'),
			'desc' => __('Select the post\'s order', 'tjoy'),
			'options' => array(
				'date' => 'date',
				'name' => 'name',
				'title' => 'title',
		...
		'type' => array(
			'type' => 'select',
			'label' => __('Post Type', 'tjoy'),
			'desc' => __('Select the post\'s type', 'tjoy'),
			'options' => array(
				'post' => 'Post',
				'portfolio' => 'Portfolio',
				'slides' => 'Slides'
...
$zilla_shortcodes['portfolio'] = array(
	...
	'params' => array(
		// 'filter' => array(
		// 	'type' => 'select',
		// 	'label' => __('Show Filter?', 'tjoy'),
		// 	'desc' => __('Sortable filter at the top.', 'tjoy'),
		// 	'options' => array(
		// 		'on' => 'On',
		// 		'off' => 'Off'
		// 	)
		...
		'cat_slug' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Categories', 'tjoy'),
			'desc' => __('Comma separate slugs to limit the portfolio items to certain categories.', 'tjoy'),
		),
		'cols' => array(
			'type' => 'select',
			'label' => __('Number of columns', 'tjoy'),
			'desc' => __('Select the number of columns. Note: set Fullwidth page template', 'tjoy'),
			'options' => array(
				'2' => '2',
				'3' => '3',
				'4' => '4'
...
$zilla_shortcodes['tabs'] = array(
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Type', 'tjoy'),
			'desc' => __('Select a type of the tabs style', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'alt' => 'Alternative'
			)
		...
		'orientation' => array(
			'type' => 'select',
			'label' => __('Type', 'tjoy'),
			'desc' => __('Select the tab\'s type', 'tjoy'),
			'options' => array(
				'horizontal' => 'Horizontal',
				'vertical' => 'Vertical'
			)
	...
	'no_preview' => true,
	'shortcode' => '[tabs type="{{type}}" orientation="{{orientation}}"] {{child_shortcode}} [/tabs]',
	'popup_title' => __('Insert Tab Shortcode', 'tjoy'),
    
	'child_shortcode' => array(
		'params' => array(
			'state' => array(
				'type' => 'select',
				'label' => __('Tab State', 'tjoy'),
				'desc' => __('Select the state of the tab on page load', 'tjoy'),
				'options' => array(
					'closed' => 'Closed',
					'open' => 'Open'
				)
	   	...
	   	'title' => array(
				'std' => 'Title',
				'type' => 'text',
				'label' => __('Tab Title', 'tjoy'),
				'desc' => __('Title of the tab', 'tjoy'),
	      ),
	      'content' => array(
				'std' => 'Tab Content',
				'type' => 'textarea',
				'label' => __('Tab Content', 'tjoy'),
				'desc' => __('Add the tabs content', 'tjoy')
	      )
	  ),
		'shortcode' => '[tab title="{{title}}" state="{{state}}"] {{content}} [/tab]',
		'clone_button' => __('Add Tab', 'tjoy')
	)
);
...
$zilla_shortcodes['pricing_table'] = array(
	'no_preview' => true,
	'params' => array(
		'name' => array(
			'std' => 'Title',
			'type' => 'text',
			'label' => __('Plan Title', 'tjoy'),
			'desc' => __('Title of the plan', 'tjoy'),
		),
		'price' => array(
			'std' => '$ 9.99',
			'type' => 'text',
			'label' => __('Plan Price', 'tjoy'),
			'desc' => __('Price of the plan', 'tjoy'),
		),
		'link_txt' => array(
			'std' => 'Purchase',
			'type' => 'text',
			'label' => __('Plan Button Text', 'tjoy'),
			'desc' => __('Button\'s text of the plan', 'tjoy'),
		),
		'link_url' => array(
			'std' => '#',
			'type' => 'text',
			'label' => __('Plan Button URL', 'tjoy'),
			'desc' => __('Button\'s url of the plan', 'tjoy'),
		),
		'active' => array(
			'type' => 'select',
			'label' => __('Featured Plan?', 'tjoy'),
			'desc' => __('If you want to highlight this plan please choose "Yes"', 'tjoy'),
			'options' => array(
				'no' => 'no',
				'yes' => 'yes'
			)
		...
		'type' => array(
			'type' => 'select',
			'label' => __('Color Style', 'tjoy'),
			'desc' => __('Pricing Table Color style.', 'tjoy'),
			'options' => array(
				'style1' => 'Style 1',
				'style2' => 'Style 2'
			)
		...
		'content' => array(
			'std' => '',
			'type' => 'textarea',
			'label' => __('Plan Content', 'tjoy'),
			'desc' => __('Add the plans content (unordered list should be here)', 'tjoy')
		)
	),
	'shortcode' => '[pricing_table name="{{name}}" price="{{price}}" link_txt="{{link_txt}}" link_url="{{link_url}}" active="{{active}}" type="{{type}}"] {{content}} [/pricing_table]',
	'popup_title' => __('Insert Pricing Table Shortcode', 'tjoy')
);
...
$zilla_shortcodes['icon'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Icon', 'tjoy'),
			'desc' => __('Choose icon here.', 'tjoy'),
			'options' => $fontawesome_icons
		),
		'size' => array(
			'type' => 'select',
			'label' => __('Size', 'tjoy'),
			'desc' => __('Choose icon size.', 'tjoy'),
			'options' => array(
				'normal' => 'Normal',
				'fa-lg' => 'Large',
				'fa-2x' => 'x2 Large',
		...
		'class' => array(
			'type' => 'text',
			'label' => __('Custom Class', 'tjoy'),
			'desc' => __('Add your CSS class for the icon. You can read more <a href="http://fontawesome.io/examples/">here</a>.', 'tjoy'),
			'std' => ''
		)
	),
	'shortcode' => '[icon type="{{type}}" size="{{size}}" class="{{class}}"]',
	'popup_title' => __('Insert Team Shortcode', 'tjoy')
);
...
$zilla_shortcodes['list'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('List Style', 'tjoy'),
			'desc' => __('Select marker type', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'square' => 'Square list',
				'arrow1' => 'Arrow1 list'
		...
		'color' => array(
			'type' => 'select',
			'label' => __('Marker Color', 'tjoy'),
			'desc' => __('Select the marker\'s color', 'tjoy'),
			'options' => array(
				'primary' => 'Primary',
				'secondary' => 'Secondary',
				'tertiary' => 'Tertiary'
	...
	'shortcode' => '[list type="{{type}}" color="{{color}}"] [/list]',
	'popup_title' => __('Insert List Shortcode', 'tjoy')
);
...
$zilla_shortcodes['dropcap'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Style', 'tjoy'),
			'desc' => __('Select the dropcap\'s style, ie the color', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'rounded' => 'Rounded',
				'squared' => 'Squared'
		...
		'content' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Dropcap Letter', 'tjoy'),
			'desc' => __('Add the single letter, ie A, B, C etc', 'tjoy'),
		)
	),
	'shortcode' => '[dropcap type="{{type}}"] {{content}} [/dropcap]',
	'popup_title' => __('Insert Dropcap Shortcode', 'tjoy')
);
...
$zilla_shortcodes['pullquote'] = array(
	'no_preview' => true,
	'params' => array(
		'align' => array(
			'type' => 'select',
			'label' => __('Align', 'tjoy'),
			'desc' => __('Pullquote align', 'tjoy'),
			'options' => array(
				'left' => 'Left',
				'right' => 'Right'
			)
		...
		'content' => array(
			'std' => '',
			'type' => 'textarea',
			'label' => __('Pullquote\'s text', 'tjoy'),
			'desc' => __('Add text here', 'tjoy'),
		)
	),
	'shortcode' => '[pullquote align="{{align}}"] {{content}} [/pullquote]',
	'popup_title' => __('Insert Pullquote Shortcode', 'tjoy')
);
...
$zilla_shortcodes['box'] = array(
	...
	'popup_title' => __('Insert Box Shortcode', 'tjoy')
);
...
$zilla_shortcodes['video_in_monitor'] = array(
	'no_preview' => true,
	'params' => array(
		'url' => array(
			'type' => 'text',
			'std' => '',
			'label' => __('URL', 'tjoy'),
			'desc' => __('Put url to video here.', 'tjoy')
		)
	),
	'shortcode' => '[video_in_monitor url="{{url}}"]',
	'popup_title' => __('Insert Video Shortcode', 'tjoy')
);
...
$zilla_shortcodes['video_in_ipad'] = array(
	'no_preview' => true,
	'params' => array(
		'url' => array(
			'type' => 'text',
	...
	'shortcode' => '[video_in_ipad url="{{url}}"]',
	'popup_title' => __('Insert Video Shortcode', 'tjoy')
);
...
$zilla_shortcodes['section'] = array(
	'no_preview' => true,
	'params' => array(
		'content' => array(
			'std' => '',
	...
	'shortcode' => '[section] {{content}} [/section]',
...
$zilla_shortcodes['testi1'] = array(
	'no_preview' => true,
	'params' => array(
		'img_url' => array(
			'type' => 'text',
			'label' => __('Author Image URL', 'tjoy'),
			'desc' => __('Put url to image.', 'tjoy'),
			'std' => ''
		),
		'name' => array(
			'type' => 'text',
			'label' => __('Author Name', 'tjoy'),
			'desc' => __('Name who wrote this testimonial.', 'tjoy'),
			'std' => ''
		),
		'info' => array(
			'type' => 'text',
			'label' => __('Author Info', 'tjoy'),
			'desc' => __('Company, position, etc.', 'tjoy'),
			'std' => ''
		),
		'content' => array(
			'std' => '',
	...
	'shortcode' => '[testi1 img_url="{{img_url}}" name="{{name}}" info="{{info}}"] {{content}} [/testi1]',
	'popup_title' => __('Insert Testimonial Shortcode', 'tjoy')
);
...
$zilla_shortcodes['testi2'] = array(
	...
	'shortcode' => '[testi2 name="{{name}}" info="{{info}}"] {{content}} [/testi2]',
	'popup_title' => __('Insert Testimonial Shortcode', 'tjoy')
);
...
$zilla_shortcodes['testi3'] = array(
	...
	'shortcode' => '[testi3 name="{{name}}" info="{{info}}"] {{content}} [/testi3]',
	'popup_title' => __('Insert Testimonial Shortcode', 'tjoy')
);
...
$zilla_shortcodes['testimonial'] = array(
	...
	'params' => array(
		'color' => array(
			'type' => 'select',
			'label' => __('Color', 'tjoy'),
			'desc' => __('Select the testimonial\'s color', 'tjoy'),
			'options' => array(
				'primary' => 'Primary',
				'secondary' => 'Secondary',
				'tertiary' => 'Tertiary'
	...
	'shortcode' => '[testimonial color="{{color}}" name="{{name}}" info="{{info}}"] {{content}} [/testimonial]',
	'popup_title' => __('Insert Testimonial Shortcode', 'tjoy')
);
...
$zilla_shortcodes['lgroup'] = array(
	'no_preview' => true,
	'shortcode' => '[lgroup color="{{color}}" size="{{size}}" align="{{align}}"] {{child_shortcode}} [/lgroup]',
	'popup_title' => __('Insert Accordion Shortcode', 'tjoy'),
	'params' => array(
		'color' => array(
			'type' => 'select',
			'label' => __('Color', 'tjoy'),
			'desc' => __('Select the list\'s color', 'tjoy'),
			'options' => array(
				'primary' => 'Primary',
				'secondary' => 'Secondary',
				'tertiary' => 'Tertiary'
		...
		'size' => array(
			'type' => 'select',
			'label' => __('Size', 'tjoy'),
			'desc' => __('Select the list\'s size', 'tjoy'),
			'options' => array(
				'normal' => 'Normal',
				'lg' => 'Large'
			)
		...
		'align' => array(
			'type' => 'select',
			'label' => __('Align', 'tjoy'),
			'desc' => __('Select the list\'s align', 'tjoy'),
			'options' => array(
				'left' => 'Left',
				'right' => 'Right',
				'center' => 'Center'
	...
	'child_shortcode' => array(
		'params' => array(
	   	...
	   	'title' => array(
				'std' => 'Title goes here',
				'type' => 'text',
				'label' => __('Heading', 'tjoy'),
				'desc' => __('Item\'s heading goes here.', 'tjoy'),
	      ),
	      'content' => array(
				'std' => 'Some description goes here',
				'type' => 'textarea',
				'label' => __('Description', 'tjoy'),
				'desc' => __('Add the item\'s description', 'tjoy')
	      )
	  ),
		'shortcode' => '[litem icon="{{icon}}" title="{{title}}" ] {{content}} [/litem]',
		'clone_button' => __('Add Item', 'tjoy')
	)
);
...
$zilla_shortcodes['title'] = array(
	...
	'params' => array(
		'style' => array(
			'type' => 'select',
			'label' => __('Style', 'tjoy'),
			'desc' => __('Select the title\'s style', 'tjoy'),
			'options' => array(
				'decorated' => 'Decorated',
				'bordered' => 'Bordered'
			)
	...
	'shortcode' => '[title style="{{style}}"] {{content}} [/title]',
	'popup_title' => __('Insert Title Shortcode', 'tjoy')
);
...
$zilla_shortcodes['accordion'] = array(
	'params' => array(),
	'no_preview' => true,
	'shortcode' => '[accordion type="{{type}}"] {{child_shortcode}} [/accordion]',
	'popup_title' => __('Insert Accordion Shortcode', 'tjoy'),
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Type', 'tjoy'),
			'desc' => __('Select accordion type', 'tjoy'),
			'options' => array(
				'type1' => 'Type 1',
				'type2' => 'Type 2'
			)
	...
	'child_shortcode' => array(
		'params' => array(
	   	'title' => array(
				'std' => 'Title',
				'type' => 'text',
				'label' => __('Panel Title', 'tjoy'),
				'desc' => __('Title of the panel', 'tjoy'),
	      ),
	      'content' => array(
				'std' => 'Content',
				'type' => 'textarea',
				'label' => __('Panel Content', 'tjoy'),
				'desc' => __('Add the panel\'s content', 'tjoy')
	      ),
	      'state' => array(
				'type' => 'select',
				'label' => __('Panel State', 'tjoy'),
				'desc' => __('Select the state of the toggle on page load', 'tjoy'),
				'options' => array(
					'closed' => 'Closed',
					'open' => 'Open'
				)
		...
		'clone_button' => __('Add Panel', 'tjoy')
	)
);
...
$zilla_shortcodes['carousel'] = array(
	...
	'params' => array(
		'post_type' => array(
			'type' => 'select',
			'label' => __('Post Type', 'tjoy'),
			'desc' => __('Choose between vertical and horizontal orientations', 'tjoy'),
			'options' => array(
				'post' => 'Blog Post',
		...
		'num' => array(
			...
			'type' => 'text',
			'label' => __('Number of Posts', 'tjoy'),
			'desc' => __('How many posts will be displayed overall', 'tjoy'),
    ),
		'visible_items' => array(
			'std' => '4',
			'type' => 'text',
			'label' => __('Visible Posts', 'tjoy'),
			'desc' => __('How many posts will be displayed at once', 'tjoy'),
    ),
    'arrow_pos' => array(
			'type' => 'select',
			'label' => __('Arrows position', 'tjoy'),
			'desc' => __('Choose arrows position (Right Top by default)', 'tjoy'),
			'options' => array(
				'default' => 'Right Top',
...
$zilla_shortcodes['partners'] = array(
	'params' => array(
		'cols' => array(
			'type' => 'select',
			'label' => __('Columns', 'tjoy'),
			'desc' => __('Select number of columns', 'tjoy'),
			'options' => array(
				'1' => '1 column',
				'2' => '2 columns',
				'3' => '3 columns',
	...
	'popup_title' => __('Insert Partners Shortcode', 'tjoy'),
	...
	'child_shortcode' => array(
		'params' => array(
	      'content' => array(
				...
				'type' => 'textarea',
				'label' => __('Item Content', 'tjoy'),
				'desc' => __('Add the item\'s content', 'tjoy')
	      )
	  ),
		'shortcode' => '[img_item] {{content}} [/img_item]',
		'clone_button' => __('Add Item', 'tjoy')
	)
);
...
$zilla_shortcodes['progress'] = array(
	...
	'params' => array(
		'type' => array(
			'type' => 'select',
			'label' => __('Type', 'tjoy'),
			'desc' => __('Choose type of progress bar', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'striped' => 'Striped',
				'animated' => 'Animated'
		...
		'color' => array(
			'type' => 'select',
			'label' => __('Style', 'tjoy'),
			'desc' => __('Choose style of progress bar', 'tjoy'),
			'options' => array(
				'default' => 'Default',
				'danger' => 'Danger',
				'warning' => 'Warning',
...
$zilla_shortcodes['img_raw'] = array(
	'no_preview' => true,
	'params' => array(
		'content' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Image', 'tjoy'),
			'desc' => __('You can insert image in Editor (i.e. leave this blank)', 'tjoy'),
		)
	),
	'shortcode' => '[img_raw] {{content}} [/img_raw]',
	'popup_title' => __('Insert Dropcap Shortcode', 'tjoy')
);
